...
func (e WebDAVFileSystem) Create(filename string) (wdfs.File, error) {
...
func (e WebDAVFileSystem) Open(filename string) (wdfs.File, error) {
	return nil, errors.New("filesystem type not supported")
}
func (e WebDAVFileSystem) OpenFile(filename string, flag int, perm os.FileMode) (wdfs.File, error) {
