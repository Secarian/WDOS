...
func (a ServerMessageBlockFileSystemAbstraction) Create(filename string) (wdfs.File, error) {
	filename = filterFilepath(filename)
...
func (a ServerMessageBlockFileSystemAbstraction) Open(filename string) (wdfs.File, error) {
...
func (a ServerMessageBlockFileSystemAbstraction) OpenFile(filename string, flag int, perm os.FileMode) (wdfs.File, error) {
	filename = toWinPath(filterFilepath(filename))
